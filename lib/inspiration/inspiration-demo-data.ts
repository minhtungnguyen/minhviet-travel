...
export const inspirationDemoItems: TravelInspirationItem[] = [
  ...
  },
  {
    ...
    tags: ['mice', 'su-kien'],
    coverImage: {
      src: '/mice-team-asia.jpg',
      alt: 'Đội ngũ chúc mừng thành công sau một chương trình MICE do Minh Việt tổ chức',
      width: 1200,
      height: 800,
    },
    coverImageAlt: 'Đội ngũ chúc mừng thành công sau một chương trình MICE do Minh Việt tổ chức',
